...
export const products: Product[] = [
  {
    ...
    presentations: [
      { id: "pres-001a", label: "Ampolleta 5ml", price: 15000, sku: "LC-AMP-5" },
      { id: "pres-001b", label: "Frasco 10ml", price: 25000, sku: "LC-FRA-10" },
    ],
    image: "/products/l-carnitina.webp",
    featured: true,
    inStock: true,
  },
  {
    ...
    presentations: [
      { id: "pres-002a", label: "Ampolleta 5ml", price: 18000, sku: "TR-AMP-5" },
      { id: "pres-002b", label: "Frasco 10ml", price: 30000, sku: "TR-FRA-10" },
    ],
    image: "/products/triac.webp",
    featured: true,
    inStock: true,
  },
  {
    ...
    presentations: [
      { id: "pres-003a", label: "Ampolleta 5ml", price: 12000, sku: "ALC-AMP-5" },
      { id: "pres-003b", label: "Frasco 10ml", price: 20000, sku: "ALC-FRA-10" },
    ],
    image: "/products/alcachofa.webp",
    featured: false,
    inStock: true,
  },
  {
    ...
    presentations: [
      { id: "pres-004a", label: "Ampolleta 5ml", price: 14000, sku: "SIO-AMP-5" },
      { id: "pres-004b", label: "Frasco 10ml", price: 24000, sku: "SIO-FRA-10" },
    ],
    image: "/products/silicio-organico.webp",
    featured: false,
    inStock: true,
  },
  {
    ...
    presentations: [
      { id: "pres-005a", label: "Ampolleta 5ml", price: 22000, sku: "TR7-AMP-5" },
      { id: "pres-005b", label: "Frasco 10ml", price: 38000, sku: "TR7-FRA-10" },
    ],
    image: "/products/tr7-coctel.webp",
    featured: true,
    inStock: true,
  },
  {
    ...
    presentations: [
      { id: "pres-006a", label: "Ampolleta 5ml", price: 8000, sku: "CB-AMP-5" },
      { id: "pres-006b", label: "Caja x10", price: 70000, sku: "CB-CJA-10" },
    ],
    image: "/products/complejo-b.webp",
    featured: false,
    inStock: true,
  },
  {
    ...
    presentations: [
      { id: "pres-007a", label: "Frasco 20ml", price: 28000, sku: "VC-FRA-20" },
      {
        id: "pres-007b",
        label: "Caja cerrada",
        price: 250000,
  ...
  },
  {
    ...
    presentations: [
      { id: "pres-008a", label: "Frasco 20ml", price: 18000, sku: "PRO-FRA-20" },
      {
        id: "pres-008b",
        label: "Caja cerrada",
        price: 160000,
