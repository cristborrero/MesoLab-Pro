    ...
    <footer className="mt-auto bg-navy text-white/90">
      <div className="mx-auto max-w-7xl px-4 py-12 lg:px-8 lg:py-16">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          {/* Navigation */}
          <div>
            <h3 className="mb-4 font-label text-xs font-medium uppercase tracking-wider text-white/40">
              Navegación
            </h3>
        ...
        <div className="mt-10 flex flex-col items-center justify-between gap-4 border-t border-white/10 pt-6 sm:flex-row">
          <p className="text-xs text-white/40">
            © {new Date().getFullYear()} MesoLab Pro. Todos los derechos
            reservados.
          </p>

          {/* Payment Methods Placeholder */}
          <div className="flex items-center gap-3 font-label text-xs text-white/30">
            <span>Visa</span>
            <span>·</span>
